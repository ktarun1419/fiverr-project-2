  ...
  return (
    <div
      className={classNames(
        "fixed z-40 top-0 left-0 h-screen bg-grad w-full xl:hidden",
    ...
    >
      ...
      <div className="">
        <ul className="flex flex-col items-center justify-between w-full space-y-11 pt-16">
          <Links />
          <li className="">
            <a
              target="_blank"
              className="px-6 py-3 truncate text-white uppercase font-medium bg-gradient-to-l from-[#c561ff] to-[#53f] rounded-full"
